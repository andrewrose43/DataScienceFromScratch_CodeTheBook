...
2) At the same time, whenever an example provides an opportunity to invent a more advanced or differently-optimized version of itself, I will create my own variant.
    -These will be contained in files named with the suffix "-variant".
    -Swathes of the "-variant" files will be simply copied from the "-annotated" files. They will differ wherever an interesting opportunity to get creative arises.
